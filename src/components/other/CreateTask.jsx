...
const CreateTask = () => {
  ...
  const submitHandler = (e) => {
    ...
    const updatedData = userData.map((employee) => {
        ...
        if (
            employee.firstName === asignTo ||
            employee.email === asignTo
        ) {
            return {
                ...employee,
            ...
            >
                ...
                <div className='w-2/5 flex flex-col items-start'>
                    ...
                    <textarea value={taskDescription}
                        ...
                        }} className='w-full h-44 text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400' name="" id="" placeholder="Enter Description"></textarea>
